...
- **우리 가족**: 아내 **박혜상**(1981.11.07), 자녀로 추정되는 은혜(2014.05.31)·혜림(2017.05.02),
  결혼기념일 2012.09.07
- **본가**: 아버지(음력 1955.03.20)·어머니(음력 1956.04.29), 결혼기념일 1978.01.27
- **처가**: 장인어른/아버님(음력 1950.05.11)·장모님/어머님(음력 1955.09.13),
...
- **음력 4분(아버지·어머니·아버님·어머님)의 실명**: 아직 모른다. 알게 되면 `name` 을 채워라.
  출생연도는 확인되어 나이 계산은 정상 동작한다.
